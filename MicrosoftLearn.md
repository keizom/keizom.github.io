...
- [Copilot Credits Guide ライセンスガイド](https://aka.ms/CopilotCredits/LicensingGuide)
- [Dynamics 365 ライセンスガイド 日本語版](https://go.microsoft.com/fwlink/?LinkId=866544\&clcid=0x411)
- [Microsoft 365 Enterprise 比較表](https://aka.ms/M365EnterprisePlans)
- [Microsoft 365 Business 比較表](https://aka.ms/M365BusinessPlans)
...
- [招待を許可またはブロックする - Microsoft Entra External ID Microsoft Learn](https://learn.microsoft.com/ja-jp/entra/external-id/allow-deny-list)- [クラウドへの移行 - ID およびアクセス管理の AD から Microsoft Entra ID への移行の概要 - Microsoft Entra Microsoft Learn](https://learn.microsoft.com/ja-jp/entra/architecture/road-to-the-cloud-introduction)
...
- [GitHub の概要](https://learn.microsoft.com/ja-jp/training/modules/introduction-to-github/)
- [.NET](https://learn.microsoft.com/ja-jp/training/dotnet/)
- [Microsoft Partner Skilling Hub](https://www.skilling-hub.com/ja-JP/)
- [Microsoft の認定資格の実践評価](https://learn.microsoft.com/ja-jp/credentials/certifications/practice-assessments-for-microsoft-certifications)
- [Microsoft 365 Copilot エージェントの基本的な管理タスクを実行する](https://learn.microsoft.com/ja-jp/training/modules/perform-admin-tasks-microsoft-365-copilot-agents/)
- [Power Automate の HTTP コネクタの概要](https://learn.microsoft.com/ja-jp/training/modules/http-connectors/)
- [無料で入手できるドキュメント／電子書籍で勉強しよう](https://atmarkit.itmedia.co.jp/ait/articles/1505/22/news022_2.html)
- [Microsoft 開発者ツールのサンプル コード - Microsoft Learn](https://learn.microsoft.com/ja-jp/samples/browse/?products=azure&sfns=mo)
- [自習書 Do-It-Yourself シリーズ - Microsoft Learn](https://learn.microsoft.com/ja-jp/previous-versions/msdn10/Gg442320(v=MSDN.10))
- [SQL Server技術ドキュメント - Microsoft Learn](https://learn.microsoft.com/ja-jp/sql/sql-server/?view=sql-server-ver17&redirectedfrom=MSDN)
- [EMS関連の手順書シリーズが公開されました](https://download.microsoft.com/download/1/D/1/1D1D9971-DDD7-435C-B1FB-18C6625FFDFE/SPE_Manual%20series.zip)


## GitHub Copilot

- [AI 支援型開発を始めよう](https://learn.microsoft.com/ja-jp/training/paths/accelerate-app-development-using-github-copilot/)
